/**
 * Marcha — Pipeline v4.1 + trayectoria
 * Agrega:
 *   - autonomía
 *   - destino
...
// ⚠️ Mantengo tu configuración actual
...
async function runPipeline({ userProfile, context }) {
  ...
  try {
    ...
    if (stationIds.length === 0) {
      return { mode: 3, recommendation: null, alternative: null, message: `No hay estaciones para ${comunaOriginal}` };
    }
